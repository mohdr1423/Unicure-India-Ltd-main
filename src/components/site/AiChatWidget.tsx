...
export function AiChatWidget() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end gap-2 pointer-events-auto select-none">
        {!open && !hasInteracted && (
        ...
        <button
          ...
          className={cn(
            "group relative grid h-13 w-13 sm:h-14 sm:w-14 place-items-center rounded-full shadow-2xl transition-all duration-300 cursor-pointer active:scale-95",
            open
      ...
      {open && (
        <div
          className={cn(
            ...
            "inset-x-3 bottom-20 top-auto h-[500px] max-h-[calc(100dvh-7.5rem)] rounded-3xl",
            // Desktop: Bottom-right floating card
            "sm:inset-x-auto sm:right-6 sm:bottom-24 sm:w-[410px] sm:max-w-[440px] sm:h-[580px] sm:max-h-[calc(100vh-8rem)]",
