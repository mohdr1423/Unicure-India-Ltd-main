...
export const Route = createFileRoute("/_authenticated/admin/contact")({
  ...
  head: () => ({
    meta: [{ title: "Contact page — Admin" }, { name: "robots", content: "noindex" }],
  }),
});
      ...
      render={({ value, setValue }) => (
        <div className="space-y-8">
          ...
          <Group
            ...
            subtitle="Cards shown mid-page with each unit's address."
          >
                ...
                <div key={i} className="rounded-md border p-3 space-y-2">
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        setValue((p) => ({ ...p, units: p.units.filter((_, j) => j !== i) }))
                      }
                    >
            ...
            <div className="space-y-3 mt-3">
              {value.channels.map((c, i) => (
                ...
                >
                  <Field
                    label={i === 0 ? "Icon" : ""}
                    hint={i === 0 ? "phone or email" : undefined}
                  >
                    <select
                      ...
                      onChange={(e) =>
                        setValue((p) => ({
                          ...p,
                          channels: p.channels.map((x, j) =>
                            j === i ? { ...x, icon: e.target.value as Channel["icon"] } : x,
                          ),
                        }))
                      }
                    >
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      setValue((p) => ({ ...p, channels: p.channels.filter((_, j) => j !== i) }))
                    }
                  >
              ...
              <Button
                ...
                onClick={() =>
                  setValue((p) => ({
                    ...p,
                    channels: [...p.channels, { icon: "email", title: "New", value: "" }],
                  }))
                }
              >
