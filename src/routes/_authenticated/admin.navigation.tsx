        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            {value.items.map((item, i) => (
              <div key={i} className="flex gap-2 items-start">
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    setValue((p) => ({ ...p, items: p.items.filter((_, idx) => idx !== i) }))
                  }
                >
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setValue((p) => ({ ...p, items: [...p.items, { label: "New link", to: "/" }] }))
              }
            >
          ...
          <div className="grid gap-3 sm:grid-cols-2 pt-4 border-t">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => setValue((p) => ({ ...p, cta_label: e.target.value }))}
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                value={value.cta_to}
                onChange={(e) => setValue((p) => ({ ...p, cta_to: e.target.value }))}
              />
            </div>
          </div>
        </div>
