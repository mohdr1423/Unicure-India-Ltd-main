...
const DEFAULTS: AboutContent = {
  ...
  values: [
    {
      title: "Mission",
      text: "Deliver affordable, quality pharmaceutical products that improve lives worldwide.",
    },
    {
      title: "Vision",
      text: "Be the most trusted manufacturing partner in emerging global markets.",
    },
    ...
    items: [
      {
        year: "1984",
        title: "Founded",
        text: "Unicure India begins operations with a vision to democratize quality medicine.",
      },
      {
        year: "1996",
        title: "WHO-GMP",
        text: "Achieved WHO-GMP certification for tablets and capsules.",
      },
      {
        year: "2005",
        title: "Exports Begin",
        text: "First international shipments to Africa and Southeast Asia.",
      },
      {
        year: "2014",
        title: "R&D Expansion",
        text: "New research center opens with advanced analytical capabilities.",
      },
      {
        year: "2020",
        title: "Injectables",
        text: "Sterile injectable line commissioned to serve critical care markets.",
      },
      {
        year: "2024",
        title: "40 Years",
        text: "Serving 20+ countries with 500+ formulations and 600+ employees.",
      },
    ],
  },
};
      ...
      render={({ value, setValue }) => (
        <div className="space-y-8">
          ...
          <Group title="Our story" subtitle="Long-form text next to the lab photo.">
            <Field label="Section title">
              <Input
                ...
                onChange={(e) =>
                  setValue((p) => ({ ...p, story: { ...p.story, title: e.target.value } }))
                }
              />
            </Field>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setValue((p) => ({
                        ...
                        story: {
                          ...p.story,
                          paragraphs: p.story.paragraphs.map((x, j) =>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setValue((p) => ({
                        ...
                        story: {
                          ...p.story,
                          paragraphs: p.story.paragraphs.filter((_, j) => j !== i),
                        },
                      }))
                    }
                  >
            ...
            <div className="space-y-3">
              {value.values.map((v, i) => (
                ...
                >
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      setValue((p) => ({ ...p, values: p.values.filter((_, j) => j !== i) }))
                    }
                  >
                    <Trash2 className="h-4 w-4" />
                  </Button>
              ...
              <Button
                ...
                onClick={() =>
                  setValue((p) => ({
                    ...p,
                    values: [...p.values, { title: "New value", text: "" }],
                  }))
                }
              >
          ...
          <Group title="Journey timeline" subtitle="Key milestones over the years.">
            <Field label="Section title">
              <Input
                value={value.timeline.title}
                onChange={(e) =>
                  setValue((p) => ({ ...p, timeline: { ...p.timeline, title: e.target.value } }))
                }
              />
            </Field>
            <div className="space-y-3 mt-3">
              {value.timeline.items.map((m, i) => (
                <div
                  key={i}
                  className="grid gap-2 sm:grid-cols-[120px_1fr_2fr_auto] items-end rounded-md border p-3"
                >
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setValue((p) => ({
                          ...
                          timeline: {
                            ...p.timeline,
                            items: p.timeline.items.map((x, j) =>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setValue((p) => ({
                        ...
                        timeline: {
                          ...p.timeline,
                          items: p.timeline.items.filter((_, j) => j !== i),
                        },
                      }))
                    }
                  >
              ...
              <Button
                ...
                onClick={() =>
                  setValue((p) => ({
                    ...
                    timeline: {
                      ...p.timeline,
                      items: [...p.timeline.items, { year: "", title: "", text: "" }],
                    },
                  }))
                }
              >
