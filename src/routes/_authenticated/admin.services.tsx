    ...
    items: [
      {
        ...
        text: "WHO-GMP approved plant manufacturing Solid Oral Dosage forms (Tablets & Capsules), Dry Syrups, Oral Liquid formulations, preparations for external application, Beta-Lactam and Hormonal section.",
      },
      {
        name: "Unit-II",
        location: "Roorkee, Uttarakhand",
        year: "Established 2006",
        text: "WHO-GMP approved plant manufacturing Solid Oral Dosage forms, Dry Powders, Oral Liquid formulations, preparations for external application, and Sex Hormone section.",
      },
      {
        name: "Unit-III",
        location: "Greater Noida",
        year: "Established 2020",
        text: "WHO-GMP approved state-of-the-art OSD facility, designed as per international guidelines — PIC/S, EU and USFDA regulations.",
      },
    ],
  },
};
...
export const Route = createFileRoute("/_authenticated/admin/services")({
  ...
  head: () => ({
    meta: [{ title: "Services page — Admin" }, { name: "robots", content: "noindex" }],
  }),
});
        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Eyebrow">
                <Input
                  ...
                  onChange={(e) =>
                    setValue((p) => ({ ...p, hero: { ...p.hero, eyebrow: e.target.value } }))
                  }
                />
              </Field>
              <Field label="Title">
                <Input
                  ...
                  onChange={(e) =>
                    setValue((p) => ({ ...p, hero: { ...p.hero, title: e.target.value } }))
                  }
                />
              </Field>
              <Field label="Subtitle">
                <Textarea
                  ...
                  onChange={(e) =>
                    setValue((p) => ({ ...p, hero: { ...p.hero, subtitle: e.target.value } }))
                  }
                />
              </Field>
            </div>
          ...
          <Group title="Dosage form capacities" subtitle="Grid of production capacities.">
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Eyebrow">
                <Input
                  value={value.capacities.eyebrow}
                  onChange={(e) =>
                    setValue((p) => ({
                      ...p,
                      capacities: { ...p.capacities, eyebrow: e.target.value },
                    }))
                  }
                />
              </Field>
              <Field label="Section title">
                <Input
                  value={value.capacities.title}
                  onChange={(e) =>
                    setValue((p) => ({
                      ...p,
                      capacities: { ...p.capacities, title: e.target.value },
                    }))
                  }
                />
              </Field>
            ...
            <div className="space-y-3 mt-3">
              {value.capacities.items.map((c, i) => (
                <div
                  key={i}
                  className="grid gap-2 sm:grid-cols-[1fr_1fr_auto] items-end rounded-md border p-3"
                >
                  <Field label={i === 0 ? "Dosage form" : ""}>
                    <Input
                      value={c.title}
                      onChange={(e) =>
                        setValue((p) => ({
                          ...
                          capacities: {
                            ...p.capacities,
                            items: p.capacities.items.map((x, j) =>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setValue((p) => ({
                        ...
                        capacities: {
                          ...p.capacities,
                          items: p.capacities.items.filter((_, j) => j !== i),
                        },
                      }))
                    }
                  >
              ...
              <Button
                ...
                onClick={() =>
                  setValue((p) => ({
                    ...
                    capacities: {
                      ...p.capacities,
                      items: [...p.capacities.items, { title: "", capacity: "" }],
                    },
                  }))
                }
              >
          ...
          <Group title="Operational units" subtitle="Cards for each manufacturing facility.">
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Eyebrow">
                <Input
                  value={value.units.eyebrow}
                  onChange={(e) =>
                    setValue((p) => ({ ...p, units: { ...p.units, eyebrow: e.target.value } }))
                  }
                />
              </Field>
              <Field label="Section title">
                <Input
                  ...
                  onChange={(e) =>
                    setValue((p) => ({ ...p, units: { ...p.units, title: e.target.value } }))
                  }
                />
              </Field>
            </div>
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      onClick={() =>
                        setValue((p) => ({
                          ...p,
                          units: { ...p.units, items: p.units.items.filter((_, j) => j !== i) },
                        }))
                      }
                    >
              ...
              <Button
                ...
                onClick={() =>
                  setValue((p) => ({
                    ...
                    units: {
                      ...p.units,
                      items: [...p.units.items, { name: "", location: "", year: "", text: "" }],
                    },
                  }))
                }
              >
