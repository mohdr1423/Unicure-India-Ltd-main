            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    value={editing.therapeutic_area ?? ""}
                    onChange={(e) => setEditing({ ...editing, therapeutic_area: e.target.value })}
                  />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <Input
                  value={editing.packaging ?? ""}
                  onChange={(e) => setEditing({ ...editing, packaging: e.target.value })}
                />
              </div>
              <MediaPicker
                label="Product image"
